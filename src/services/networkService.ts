...
export const initialNetworkUsers: NetworkUser[] = [
  {
    ...
    interests: ['Cloud Architecture', 'Distributed Systems', 'Go Programming', 'Mentorship', 'Open Source'],
    onlineStatus: 'online',
    certificates: [
      {
        id: 'cert-ps-1',
  ...
  },
  {
    ...
    interests: ['Technical Recruiting', 'Fintech & Payments', 'SWE Internships', 'Resume Optimization'],
    onlineStatus: 'online',
    certificates: [],
    projects: [
      {
  ...
  },
  {
    ...
    interests: ['AI & Machine Learning', 'Gemini & Multimodal LLMs', 'Deep Learning Research', 'RLHF'],
    onlineStatus: 'idle',
    certificates: [
      {
        id: 'cert-er-1',
  ...
  },
  {
    ...
    interests: ['Full-Stack Web', 'React 19 & Next.js', 'UI/UX Design Systems', 'Open Source'],
    onlineStatus: 'online',
    certificates: [],
    projects: [
      {
  ...
  {
    id: 'user-sophia-lin',
    userId: '@sophia_security',
    username: 'sophia_security',
    name: 'Sophia Lin',
    headline: 'Security Engineer @ Cloudflare • Zero Trust & Cryptography • Rust Enthusiast',
    avatarUrl: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&auto=format&fit=crop&q=80',
    coverUrl: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=1000&auto=format&fit=crop&q=80',
    company: 'Cloudflare',
    role: 'Security Engineer',
    location: 'Austin, TX / Remote',
    bio: 'Securing edge compute networks and building post-quantum cryptography primitives in Rust. Let’s talk WebAssembly and zero-trust auth.',
    followersCount: 5120,
    followingCount: 340,
    isFollowing: false,
    isFollower: false,
    ...
    isPrivate: false,
    mutualCount: 8,
    skills: ['Cybersecurity', 'Rust', 'WebAssembly', 'Cryptography', 'Cloudflare Workers'],
    interests: ['Cybersecurity', 'Zero Trust Architecture', 'Rust Systems', 'Cloudflare Workers'],
    onlineStatus: 'online',
    certificates: [],
    projects: [
      {
        id: 'proj-vault-wasm',
        title: 'WasmCrypto: In-Memory Client Keystore',
        description: 'WebAssembly-powered AES-GCM and ChaCha20 encryption harness for browser local storage.',
        tags: ['Rust', 'WebAssembly', 'Cryptography'],
        githubUrl: 'https://github.com/sophialin/wasm-crypto',
        date: '2025',
        stars: 670,
      },
    ],
  ...
  },
  {
    ...
    name: 'Arjun Mehta',
    headline: 'Site Reliability Engineer @ Datadog • K8s & Terraform • AWS Certified Solutions Architect',
    avatarUrl: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&auto=format&fit=crop&q=80',
    coverUrl: 'https://images.unsplash.com/photo-1544383835-bda2bc66a55d?w=1000&auto=format&fit=crop&q=80',
    company: 'Datadog',
    role: 'Site Reliability Engineer',
    location: 'New York, NY',
    bio: 'Automating multi-cloud Kubernetes clusters with Terraform and ArgoCD. Helping students land high-scale infrastructure roles.',
    followersCount: 6890,
    followingCount: 410,
    isFollowing: false,
    isFollower: true,
    ...
    interests: ['DevOps & CI/CD', 'Cloud Infrastructure', 'Kubernetes', 'Observability'],
    onlineStatus: 'online',
    certificates: [],
    projects: [
      {
        id: 'proj-gitops-infra',
        title: 'GitOps Multi-Region K8s Blueprint',
        description: 'Automated Terraform and ArgoCD repository provisioning isolated canary deployments.',
        tags: ['Terraform', 'Kubernetes', 'ArgoCD'],
        githubUrl: 'https://github.com/arjunmehta/gitops-blueprint',
        date: '2025',
        stars: 1120,
      },
    ],
