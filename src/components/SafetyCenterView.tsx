...
export const SafetyCenterView: React.FC<SafetyCenterViewProps> = ({
  ...
  return (
    <main className="pt-20 md:pt-24 pb-28 px-4 sm:px-6 max-w-md md:max-w-2xl mx-auto flex flex-col gap-6">
      {/* Page Header */}
      <section className="flex flex-col gap-1.5 pt-2">
        ...
        <p className="text-[15px] text-[#434655] dark:text-[#c3c6d7] leading-relaxed">
          Check before you apply. Our AI scans for common red flags, upfront fee scams, and suspicious recruitment patterns.
        </p>
      </section>
      ...
      {/* Input Section: Analyze Opportunity */}
      <div className="bg-white dark:bg-[#1e293b] rounded-2xl p-5 sm:p-6 neu-raised flex flex-col gap-4">
      ...
      {/* Result Card: Safety Report */}
      {hasScanned && (
        <div className="bg-white dark:bg-[#1e293b] rounded-2xl p-5 sm:p-6 neu-raised flex flex-col gap-5 relative overflow-hidden border border-slate-100 dark:border-slate-800">
          {/* Decorative AI Halo */}
